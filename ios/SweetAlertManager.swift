//
//  SweetAlertManager.swift
//  HNPageApp
//
//  Created by Hung Nguyen on 4/7/22.
//
import Foundation
...
class SweetAlertManager: RCTViewManager {
    ...
    func showAlertWithOptions(_ options: NSDictionary, callback: @escaping RCTResponseSenderBlock) {
        ...
        default:
         ...
         alert.showAlert(title, subTitle: subTitle, style: convertedStyle, buttonTitle: confirmButtonTitle, buttonColor: hexStringToUIColor(hex: confirmButtonColor), otherButtonTitle: otherButtonTitle, otherButtonColor: hexStringToUIColor(hex: otherButtonColor), action: { (isOtherButton: Bool) in
            // True == isOtherButton.
